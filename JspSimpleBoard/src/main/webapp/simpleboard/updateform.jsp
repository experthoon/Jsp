	...
	<form action = "updateaction.jsp" method = "post" enctype = "multipart/form-data">
		...
		<table class = "table table-bordered" style ="width:500px;">
			...
			<tr>
				...
				<td>
					<input type = "text" name = "pass" style = "width:300px;" class = "form-control" placeholder = "비밀번호"  required ="required"
					pattern="[0-9]{4}">
				</td>
			</tr>
			...
			<tr>
				...
				<input type ="button"class="btn btn-warning" value = "목록으로" onclick = "location.href='boardlist.jsp'">
				</td>
			</tr>
		</table>
	</form>
